...
const DashboardPage = () => {
  ...
  <h2 className="text-3xl font-extrabold text-green-700 mb-4">Welcome to Excel Analytics Platform</h2>

  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    {/* Feature Highlights */}
    <div className="bg-white border-l-4 border-green-500 shadow-md rounded-lg p-5">
      <h3 className="text-xl font-bold text-gray-800 mb-2">📊 Upload & Analyze Excel Files</h3>
      <p className="text-gray-700">
        Upload `.xlsx` or `.xls` files and instantly visualize your data using dynamic charts and tables.
      </p>
    </div>

    <div className="bg-white border-l-4 border-blue-500 shadow-md rounded-lg p-5">
      <h3 className="text-xl font-bold text-gray-800 mb-2">🧠 AI Insights (Coming Soon)</h3>
      <p className="text-gray-700">
        Automatically generate insights and summaries from your Excel data using AI.
      </p>
    </div>

    <div className="bg-white border-l-4 border-yellow-500 shadow-md rounded-lg p-5">
      <h3 className="text-xl font-bold text-gray-800 mb-2">📁 Upload History</h3>
      <p className="text-gray-700">
        Access and manage your previously uploaded files, including data and visualizations.
      </p>
    </div>

    <div className="bg-white border-l-4 border-purple-500 shadow-md rounded-lg p-5">
      <h3 className="text-xl font-bold text-gray-800 mb-2">🛠️ Admin Dashboard</h3>
      <p className="text-gray-700">
        Admins can manage users, uploaded files, and platform statistics (restricted access).
      </p>
    </div>
  </div>
  ...
  <div className="mt-8 bg-white shadow-lg rounded-lg p-4">
    <h4 className="text-lg font-semibold text-gray-800 mb-2">📋 Sample Data Preview</h4>
